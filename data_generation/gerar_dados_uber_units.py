...
sintético a uma tabela de dimensão legada real), simulando extrações completas
de um sistema de origem externo em datas distintas, com mudanças de
...
MERGE contra a dimensão legada.
"""
